               ...
               <!-- 检索结果显示 -->
                <div class="col-md-12">
                    ...
                    <?php if(is_array($searchResult)): $i = 0; $__LIST__ = $searchResult;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="article-list">
                        ...
                        <hr/><?php endforeach; endif; else: echo "" ;endif; endif; ?>
                </div>
            </div>
            <?php else: ?><!-- 分界 -->
                <div class="col-md-3">
                    <ul class="side-nav">
                        <?php if(is_array($category_article)): $i = 0; $__LIST__ = $category_article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ca): $mod = ($i % 2 );++$i; if(is_array($ca['children'])): $i = 0; $__LIST__ = $ca['children'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ca1): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Article/category',array('category_id'=>$key,'lan_id'=>$lang_id));?>">
                                    <li>
                ...
                <div class="col-md-8">
                    <div class="headline row">
                        <div class="col-md-12 col-xs-12">
                            <ol class="my-breadcrumb">
                                ...
                                <?php if(empty($oneName)): ?><li style="display: none"></li><?php else: ?><li><?php echo ($oneName); ?></li><?php endif; ?>
                    ...
                    <?php if(is_array($category_article)): $i = 0; $__LIST__ = $category_article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ca): $mod = ($i % 2 );++$i;?><div class="article-list">
                            ...
                            <div class="row">
                                ...
                                <?php if(empty($ca['create_time'])): ?><div class="col-md-3"></div>
                                    <?php else: ?>
                                    <div class="col-md-3"><?php echo date('Y-m-d',$ca['create_time']);?></div><?php endif; ?>
                            </div><?php endif; ?>
                        </div>
                        <hr/><?php endforeach; endif; else: echo "" ;endif; ?>
                    <br>
                    <div class="row page">
                        <div class="col-md-10 col-md-offset-1 paging"><?php echo ($page); ?></div>
                    </div>
                </div><?php endif; ?>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    var _ROOT_ = '/sis',
            ...
            _ACTION_ = '/sis/index.php/Home/Article/category',
...
<script type="text/javascript">
    ...
    window._SELF_='<?php echo urldecode("/sis/index.php/Home/Article/category/category_id/20/lan_id/2.html");?>';
</script>
<!-- BEGIN CORE SCRIPTS -->
